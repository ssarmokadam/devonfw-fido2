...
import com.cg.webauthndemo.general.logic.impl.config.DefaultRolesPrefixPostProcessor;
...
public class WebSecurityBeansConfig {
  ...
  //
  // WebAuthnProcessingFilter webAuthnProcessingFilter = new WebAuthnProcessingFilter(new ArrayList<>(),
  // serverPropertyProvider(rpIdProvider(), challengeRepository()));
  // webAuthnProcessingFilter.setAuthenticationSuccessHandler(authenticationSuccessHandler());
  // webAuthnProcessingFilter.setAuthenticationFailureHandler(authenticationFailureHandler());
  // webAuthnProcessingFilter.setRequiresAuthenticationRequestMatcher(new AntPathRequestMatcher("*"));
  // // webAuthnProcessingFilter.setAuthenticationManager(this.authenticationManager);
